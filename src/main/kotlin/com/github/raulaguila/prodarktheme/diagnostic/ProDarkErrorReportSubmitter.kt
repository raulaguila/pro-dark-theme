package com.github.raulaguila.prodarktheme.diagnostic
...
class ProDarkErrorReportSubmitter: ErrorReportSubmitter() {

    private val packageAbbreviation: Map<String, String>? = null

    override fun getReportActionText(): String {
        return "Report to Pro Dark Theme"
    }
    ...
    private fun getReportBody(events: Array<out IdeaLoggingEvent>, additionalInfo: String?): String {
        ...
        val plugin = PluginManagerCore.getPlugin(PluginId.getId("com.github.raulaguila.prodarktheme"))
    ...
    private fun getReportIssueUrl(title: String, body: String): URI? {
        val uriBuilder = URIBuilder("https://github.com/raulaguila/pro-dark-theme/issues/new")
